...
public class RecordListRvSecond extends RecyclerView.Adapter<RecordListRvSecond.DataObjectHolder> {
    ...
    public RecordListRvSecond(ArrayList<Records> myDataset, Context context) {
        mDataset = myDataset;
        this.context = context;
    }

    public void setOnItemClickListener(MyClickListener myClickListener) {
        RecordListRvSecond.myClickListener = myClickListener;
    }

    @Override
    public DataObjectHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.records_single_row_second, parent, false);
